...
public sealed record Node(string Fqdn, string Ip, string? Subnet, Customer Customer, DateTime FirstSeen);
...
public sealed record GraphResponse(IReadOnlyList<Node> Nodes, IReadOnlyList<Edge> Edges);

public sealed record GraphCursor(DateTime LastSeen, long LastRowId);
