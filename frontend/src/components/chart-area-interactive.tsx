...
type ChartPoint = { date: string; total: number; distinct: number }
...
export function ChartAreaInteractive({ data, loading }: { data: ChartPoint[]; loading?: boolean }) {
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Cumulative seen events and distinct connections per day
          </span>
          <span className="@[540px]/card:hidden">Daily connection counts</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
